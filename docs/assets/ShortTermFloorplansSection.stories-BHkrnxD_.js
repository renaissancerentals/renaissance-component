import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as p}from"./index-DlV_ZNC-.js";import{V as _}from"./VideoModal-Bnqf0XMO.js";import{S as q,s as V,a as R}from"./ShortTermService-g1NNXyfL.js";import{S as H}from"./ShortTermFloorplanCard-BcZxDAuW.js";import{D as U,B as W,s as Y}from"./Bedroom-CjCeEXjO.js";import{A as G,w as J,a as z,G as C,O as K}from"./index.es-CPsIdmmi.js";import{j as E,k as B}from"./Utils-BEMyHh2e.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./Api-BvKIhxln.js";import"./AssetService-BHWYquN_.js";import"./video-icon-DUlcs8Mk.js";import"./index-C0QTL6_X.js";import"./index-p5Ixs3OV.js";const O=({filters:t,handleFilterChange:l,currentFilters:i})=>e.jsx(U,{label:"Home Type",children:Array.from(t.keys()).map(n=>e.jsx(G,{label:E(B(n)),name:n,onChange:()=>{l(n)},checked:()=>i.indexOf(n)>-1},n))});O.__docgenInfo={description:"",methods:[],displayName:"ShortTermStyleFilter",props:{filters:{required:!0,tsType:{name:"Set",elements:[{name:"ShortTermStyle"}],raw:"Set<ShortTermStyle>"},description:""},handleFilterChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(filter: ShortTermStyle) => void",signature:{arguments:[{type:{name:"ShortTermStyle"},name:"filter"}],return:{name:"void"}}},description:""},currentFilters:{required:!0,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""}}};const Z=({sortBy:t,handleSortChange:l})=>{const[i,n]=p.useState(!1);return e.jsx("div",{className:"unit-dropdown",children:e.jsx(J,{element:e.jsxs("h5",{children:[q[t].element,"  ",e.jsx("span",{className:"small",children:"▼"})]}),showContent:i,setShowContent:n,size:"medium",variant:"primary",drop:"left",children:e.jsx("div",{className:"sort-filters",children:Object.keys(q).map(s=>e.jsx(z,{active:t===s,onClick:()=>{l(s),n(!1)},children:q[s].element},s))})})})};Z.__docgenInfo={description:"",methods:[],displayName:"ShortTermSort",props:{sortBy:{required:!0,tsType:{name:"union",raw:"keyof typeof ShortTermSortFields",elements:[{name:"literal",value:"priceAsc"},{name:"literal",value:"priceDesc"},{name:"literal",value:"bedroomsAsc"},{name:"literal",value:"bedroomsDesc"}]},description:""},handleSortChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(sortBy: ShortTermSortBy) => void",signature:{arguments:[{type:{name:"union",raw:"keyof typeof ShortTermSortFields",elements:[{name:"literal",value:"priceAsc"},{name:"literal",value:"priceDesc"},{name:"literal",value:"bedroomsAsc"},{name:"literal",value:"bedroomsDesc"}]},name:"sortBy"}],return:{name:"void"}}},description:""}}};const P=({title:t,filters:l,floorplans:i,setCurrentFloorplans:n,isCondensed:s,currentFloorplansCount:u,defaultFloorplanStyle:h,defaultBedRooms:y,defaultMaxRent:T,defaultMinRent:F,defaultFloorplanIds:f})=>{const[m,S]=p.useState(y?[y]:[]),[c,b]=p.useState(h?[h]:[]),[v,j]=p.useState("priceAsc"),[a,M]=p.useState(f||[]),x={bedroomFilters:m,styleFilters:c,sortBy:v,floorplanIds:a},g=r=>{n(V(i,r))},D=r=>{const d=m.indexOf(r),o=[...m];d>-1?o.splice(d,1):o.push(r),S(o),g({...x,bedroomFilters:o})},Q=r=>{const d=a.indexOf(r),o=[...a];d>-1&&o.splice(d,1),M(o),g({...x,floorplanIds:o})},N=r=>{const d=c.indexOf(r),o=[...c];d>-1?o.splice(d,1):o.push(r),b(o),g({...x,styleFilters:o})},X=r=>{j(r),g({...x,sortBy:r})};return e.jsx("header",{className:"short-term-floorplans-header",children:e.jsxs("div",{className:s?"":"container",children:[e.jsx("h2",{children:t}),e.jsxs("div",{className:"units-filters",children:[e.jsxs("div",{className:"filter-group",children:[e.jsx("label",{className:"filter-label",children:"Filter By:"}),e.jsxs("div",{className:"filters",children:[e.jsx(W,{filters:l.bedroom,handleFilterChange:D,currentFilters:m}),e.jsx(O,{filters:l.style,handleFilterChange:N,currentFilters:c})]})]}),e.jsxs("div",{className:"filter-group",children:[e.jsx("label",{className:"filter-label",children:"Sort By:"}),e.jsx("div",{className:"filters",children:e.jsx(Z,{sortBy:v,handleSortChange:X})})]})]}),e.jsxs("div",{className:"pills",children:[m.sort(Y).map(r=>e.jsx(C,{pillCloseHandler:()=>{D(r)},children:r+" bedroom"},r)),c.map(r=>e.jsx(C,{pillCloseHandler:()=>{N(r)},children:E(B(r))},r)),a.sort().map(r=>e.jsx(C,{pillCloseHandler:()=>{Q(r)},children:r},r)),e.jsxs("div",{className:"filter-result",children:[e.jsx(K,{name:"filter"})," Total: ",u," Results"]})]})]})})};P.__docgenInfo={description:"",methods:[],displayName:"ShortTermFloorplansHeader",props:{defaultBedRooms:{required:!1,tsType:{name:"number"},description:""},defaultFloorplanStyle:{required:!1,tsType:{name:"ShortTermStyle"},description:""},defaultMinRent:{required:!1,tsType:{name:"number"},description:""},defaultMaxRent:{required:!1,tsType:{name:"number"},description:""},defaultFloorplanIds:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},title:{required:!1,tsType:{name:"string"},description:""},filters:{required:!0,tsType:{name:"ShortTermFilters"},description:""},floorplans:{required:!0,tsType:{name:"Array",elements:[{name:"FloorplanShortTerm"}],raw:"FloorplanShortTerm[]"},description:""},setCurrentFloorplans:{required:!0,tsType:{name:"signature",type:"function",raw:"(floorplans: FloorplanShortTerm[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"FloorplanShortTerm"}],raw:"FloorplanShortTerm[]"},name:"floorplans"}],return:{name:"void"}}},description:""},isCondensed:{required:!1,tsType:{name:"boolean"},description:""},currentFloorplansCount:{required:!0,tsType:{name:"number"},description:""}}};const I=({floorplans:t,title:l="Floor plans",isCondensed:i=!0,propertyId:n,defaultFloorplanStyle:s,defaultBedRooms:u,defaultMaxRent:h,defaultMinRent:y,defaultFloorplanIds:T})=>{const[F,f]=p.useState(V(t,{bedroomFilters:u?[u]:[],styleFilters:s?[s]:[],sortBy:"priceAsc",floorplanIds:T||[]})),[m,S]=p.useState(!1),[c,b]=p.useState({}),v=a=>{f(a)},j=a=>{b(a),S(!0)};return e.jsx(e.Fragment,{children:e.jsxs("section",{className:"section-short-term-floorplans",children:[e.jsx(_,{video:c,showModal:m,setShowModal:S}),e.jsxs("div",{className:i?"container":"",children:[e.jsx(P,{title:l,filters:R(t),floorplans:t,setCurrentFloorplans:v,isCondensed:i,currentFloorplansCount:F.length,defaultFloorplanStyle:s,defaultBedRooms:u,defaultMaxRent:h,defaultMinRent:y,defaultFloorplanIds:T}),e.jsx("div",{className:i?"":"container",children:e.jsx("div",{className:"floorplans-body",children:F.length===0?e.jsx(e.Fragment,{children:e.jsx("p",{className:"floorplan-banner",children:"No matches found..."})}):F.map((a,M)=>e.jsx(H,{floorplan:a,propertyId:n,videoClickHandler:j},M))})})]})]})})};I.__docgenInfo={description:"",methods:[],displayName:"ShortTermFloorplansSection",props:{defaultBedRooms:{required:!1,tsType:{name:"number"},description:""},defaultFloorplanStyle:{required:!1,tsType:{name:"ShortTermStyle"},description:""},defaultMinRent:{required:!1,tsType:{name:"number"},description:""},defaultMaxRent:{required:!1,tsType:{name:"number"},description:""},defaultFloorplanIds:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},floorplans:{required:!0,tsType:{name:"Array",elements:[{name:"FloorplanShortTerm"}],raw:"FloorplanShortTerm[]"},description:""},title:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'"Floor plans"',computed:!1}},isCondensed:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},propertyId:{required:!0,tsType:{name:"string"},description:""}}};const ue={component:I,title:"Short Term/Short Term Floorplans",render:t=>e.jsx(I,{...t})},w={args:{propertyId:"summer-house-short-term",floorplans:[{name:"2 Flat",id:"2-flat",active:!0,style:"APARTMENT",bedroom:2,photo:"https://drive.google.com/uc?id=1xL9C-pvoZZpoZXUyPb3ADBWSXPVxtFoQ&export=download",bathroom:2,videoTourLink:"",threeSixtyVideoTourLink:"",virtualTourLink:"",coverImage:"https://drive.google.com/uc?id=1xE7uIpSBD_A0BnxH9BEW421SwvcOfe3M&export=download",floorPlanFolderId:"1CM51fpSEPVpjSxSi9Vd0ZvGMhetrxlnD",photosFolderId:"1FN5Y5hYgqnJVu8hcwrOofY-uxQIIiQIl",photosCount:12,priceFor14To29Days:"119.0",priceFor1To4Months:"93.0",priceFor4andMoreMonths:"81.0",squareFoot:750},{name:"2 townhome",id:"2-townhome",active:!0,style:"TOWN_HOME",bedroom:2,photo:"https://drive.google.com/uc?id=1hy8y7cOnPHtS5f8jX2nTTIUD2sTWfavi&export=download",bathroom:2.5,videoTourLink:"",threeSixtyVideoTourLink:"",virtualTourLink:"",coverImage:"https://drive.google.com/uc?id=1ECLJhZIErwCcsSwaKIqCcfujb9gEvn0C&export=download",floorPlanFolderId:"1k2JkyDm4vfQ7fjqVldMJbh148ETMQqqy",photosFolderId:"1iwVLQvvXjT8RetsuJjQvqXkQfy7D0CLt",photosCount:16,priceFor14To29Days:"127.0",priceFor1To4Months:"101.0",priceFor4andMoreMonths:"89.0",squareFoot:1132},{name:"1 bedroom",id:"1-bedroom",active:!0,style:"APARTMENT",bedroom:1,photo:"https://drive.google.com/uc?id=1os9y4hbObiRDyMDudrQoyTCla0ZQd3qn&export=download",bathroom:1,videoTourLink:"https://youtu.be/4q2Mppt2_hM",threeSixtyVideoTourLink:"https://youtu.be/1XNcZirYNnk",virtualTourLink:"https://viewer.divein.studio/story/O0m-6wU",coverImage:"https://drive.google.com/uc?id=1wCrmxIbiNJIGoXlUq8cwAszFTFhBWD7Z&export=download",floorPlanFolderId:"1PYtR2Z9ZEGXY_7WwGXHtl31FeeuLdyYZ",photosFolderId:"1FdMOapUlUUuqWVVlDpobXwxp3Lp_cG3E",photosCount:11,priceFor14To29Days:"102.0",priceFor1To4Months:"75.0",priceFor4andMoreMonths:"63.0",squareFoot:501}]}};var k,A,L;w.parameters={...w.parameters,docs:{...(k=w.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
...
}`,...(L=(A=w.parameters)==null?void 0:A.docs)==null?void 0:L.source}}};const he=["Default"];export{w as Default,he as __namedExportsOrder,ue as default};
